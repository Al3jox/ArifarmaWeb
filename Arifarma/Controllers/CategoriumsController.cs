...
namespace Arifarma.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(drogueria_arifarmaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          ...
                          Problem("Entity set 'drogueria_arifarmaContext.Categoria'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CodCategoria,Nombre,Descripción")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CodCategoria,Nombre,Descripción")] Categorium categorium)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'drogueria_arifarmaContext.Categoria'  is null.");
            }
            var categorium = await _context.Categoria.FindAsync(id);
            if (categorium != null)
            {
        ...
        {
          return (_context.Categoria?.Any(e => e.CodCategoria == id)).GetValueOrDefault();
        }
    }
}
