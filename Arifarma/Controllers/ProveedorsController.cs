...
namespace Arifarma.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ProveedorsController(drogueria_arifarmaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedors != null ? 
                          ...
                          Problem("Entity set 'drogueria_arifarmaContext.Proveedors'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CodProveedor,Nombre,Telefono,Dirección,Email")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CodProveedor,Nombre,Telefono,Dirección,Email")] Proveedor proveedor)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'drogueria_arifarmaContext.Proveedors'  is null.");
            }
            var proveedor = await _context.Proveedors.FindAsync(id);
            if (proveedor != null)
            {
